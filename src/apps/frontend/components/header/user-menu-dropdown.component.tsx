...
const UserMenuDropdown: React.FC<UserMenuDropdownProps> = ({
  ...
  <div
    ...
    className={`absolute right-0 mt-4 flex w-56 flex-col gap-5 rounded-sm border border-stroke bg-white px-6 py-5 shadow-default dark:border-strokedark dark:bg-boxdark ${
