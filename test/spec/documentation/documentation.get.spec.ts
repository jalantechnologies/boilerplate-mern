...
describe('GET /api/get-documentation', () => {
  ...
  it('should return the documentation when documentation is enabled for the environment', async () => {
    ...
    sinonSandbox
      .stub(DocumentationService, 'controllerFileSuffix')
      .value('-controller.ts');
    sinonSandbox
      .stub(DocumentationService, 'routerFileSuffix')
      .value('-router.ts');
    sinonSandbox
      .stub(DocumentationService, 'serializerFileSuffix')
      .value('-serializer.ts');
  ...
  it('should throw an error when it is unable to access the required files', async () => {
    ...
    }/${DocumentationService.restApiFolderPath}`;
