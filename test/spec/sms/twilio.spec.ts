...
describe('SMS Service', function() {
  ...
  it('should not allow to send sms, if the reciepient phone number is invalid', async function() {
    const params = {
      to: {
        countryCode: '+91',
        phoneNumber: '73001',
  ...
  it('should not allow to send sms, if the message body is empty.', async function() {
    const params = {
      to: {
        countryCode: '+91',
